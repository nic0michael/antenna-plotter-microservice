...
public class AntennaVswrData {
	...
	public AntennaVswrData() {}

	public AntennaVswrData(@NotBlank Long antennaDataId, @NotBlank double frequency, @NotBlank double measurementValue,
