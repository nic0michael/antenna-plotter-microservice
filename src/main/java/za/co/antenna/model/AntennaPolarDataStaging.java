...
@Entity
@Table(name = "antenna_polar_data_staging")
public class AntennaPolarDataStaging {
	...
	public AntennaPolarDataStaging() {}

	public AntennaPolarDataStaging(@NotBlank Long antennaDataId, @NotBlank double angle, @NotBlank double measurementValue,
