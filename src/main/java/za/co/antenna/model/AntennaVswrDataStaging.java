...
@Entity
@Table(name = "antenna_vswr_data_staging")
public class AntennaVswrDataStaging {
	...
	public AntennaVswrDataStaging() {}

	public AntennaVswrDataStaging(@NotBlank Long antennaDataId, @NotBlank double frequency, @NotBlank double measurementValue,
	...
	public String toString() {
		return "AntennaVswrData [id=" + id + ", antennaDataId=" + antennaDataId + ", frequency=" + frequency
