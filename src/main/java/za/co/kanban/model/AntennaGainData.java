...
public class AntennaGainData {
	...
	public AntennaGainData() {}

	public AntennaGainData(@NotBlank Long antennaDataId, @NotBlank double frequency, @NotBlank double measurementValue,
	...
	public String toString() {
		return "AntennaGainData [id=" + id + ", antennaDataId=" + antennaDataId + ", frequency=" + frequency
